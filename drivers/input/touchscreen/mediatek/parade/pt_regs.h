...
#define PT_PIP2_BIN_FILE_PATH "/data/pt_fw.bin"
#define PT_SUPPRESS_AUTO_BL 1
#define PT_ALLOW_AUTO_BL   0
...
#define PT_MAX_PIP_MSG_SIZE 255
...
#define ENABLE_DBG 0
#if ENABLE_DBG
#define PD_DBG(fmt,arg...) printk("parade:"fmt ,##arg)
#else
#define PD_DBG(fmt,arg...)
#endif
/*
...
#define pt_debug(dev, dlevel, format, arg...)	 \
	do { \
		...
		if (cd_tmp->debug_level >= dlevel) {\
			if (dlevel == DL_ERROR)\
				dev_err(dev, "parade:[%d] "format, dlevel, ##arg);\
			else\
				dev_info(dev, "parade:[%d] "format, dlevel, ##arg);\
		} \
	} while (0)
...
#define PT_HID_VENDOR_ID				0x04B4
#define PT_HID_BL_PRODUCT_ID				0xC100
#define PT_HID_APP_PRODUCT_ID				0xC101
#define PT_HID_VERSION					0x0100
#define PT_HID_APP_REPORT_ID				0xF7
#define PT_HID_BL_REPORT_ID				0xFF
#define PT_HID_RESPONSE_REPORT_ID			0xF0
...
#define PT_DRV_DBG_SET_PIP2_LAUNCH_APP   207 /* depricated */
#define PT_DRV_DBG_SET_TT_DATA           208
#define PT_DRV_DBG_SET_RUN_FW_PIN        209
...
enum hid_output {
	HID_OUTPUT_NULL                        = 0x00,
	HID_OUTPUT_START_BOOTLOADER            = 0x01,
	HID_OUTPUT_GET_SYSINFO                 = 0x02,
	HID_OUTPUT_SUSPEND_SCANNING            = 0x03,
	HID_OUTPUT_RESUME_SCANNING             = 0x04,
	HID_OUTPUT_GET_PARAM                   = 0x05,
	HID_OUTPUT_SET_PARAM                   = 0x06,
	HID_OUTPUT_GET_NOISE_METRICS           = 0x07,
	HID_OUTPUT_RESERVED                    = 0x08,
	HID_OUTPUT_ENTER_EASYWAKE_STATE        = 0x09,
	HID_OUTPUT_VERIFY_CONFIG_BLOCK_CRC     = 0x20,
	HID_OUTPUT_GET_CONFIG_ROW_SIZE         = 0x21,
	HID_OUTPUT_READ_CONF_BLOCK             = 0x22,
	HID_OUTPUT_WRITE_CONF_BLOCK            = 0x23,
	HID_OUTPUT_GET_DATA_STRUCTURE          = 0x24,
	HID_OUTPUT_LOAD_SELF_TEST_PARAM        = 0x25,
	HID_OUTPUT_RUN_SELF_TEST               = 0x26,
	HID_OUTPUT_GET_SELF_TEST_RESULT        = 0x27,
	HID_OUTPUT_CALIBRATE_IDACS             = 0x28,
	HID_OUTPUT_INITIALIZE_BASELINES        = 0x29,
	HID_OUTPUT_EXEC_PANEL_SCAN             = 0x2A,
	HID_OUTPUT_RETRIEVE_PANEL_SCAN         = 0x2B,
	HID_OUTPUT_START_SENSOR_DATA_MODE      = 0x2C,
	HID_OUTPUT_STOP_SENSOR_DATA_MODE       = 0x2D,
	HID_OUTPUT_START_TRACKING_HEATMAP_MODE = 0x2E,
	HID_OUTPUT_START_SELF_CAP_RPT_MODE     = 0x2F,
	HID_OUTPUT_CALIBRATE_DEVICE_EXTENDED   = 0x30,
	HID_OUTPUT_INT_PIN_OVERRIDE            = 0x40,
	HID_OUTPUT_STORE_PANEL_SCAN            = 0x60,
	HID_OUTPUT_PROCESS_PANEL_SCAN          = 0x61,
...
#define PT_MAX_SELF_TEST_PARAM 243
...
struct pt_core_commands {
	...
	int (*request_pip2_get_mode)(struct device *dev, int protect,
		u8 *mode, u8 *sys_mode);
