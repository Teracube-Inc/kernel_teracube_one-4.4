...
/*****************************************************************************
*
* File Name: focaltech_upgrade_ft3427.c
*
...
*****************************************************************************/
static int fts_ft3427_init(void)
{
    ...
    upgrade_func_ft3427.fwveroff = upg->fw_length - 2;
    return 0;
}

/************************************************************************
* Name: fts_ft3427_upgrade
* Brief:
* Input:
* Output:
* Return: return 0 if success, otherwise return error code
***********************************************************************/
static int fts_ft3427_upgrade(struct i2c_client *client, u8 *buf, u32 len)
{
    int ret = 0;
    u32 start_addr = 0;
    u8 cmd[4] = { 0 };
    ...
    /* write app */
    start_addr = upgrade_func_ft3427.appoff;
...
struct upgrade_func upgrade_func_ft3427 = {
    .ctype = {0x02},
    .fwveroff = 0x0000,
    .fwcfgoff = 0xD780,
    .appoff = 0x0000,
    ...
    .hid_supported = true,
    .init = fts_ft3427_init,
    .upgrade = fts_ft3427_upgrade,
};
