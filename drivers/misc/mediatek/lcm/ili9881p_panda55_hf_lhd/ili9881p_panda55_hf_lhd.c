...
static void lcm_get_params(LCM_PARAMS *params)
{
  ...
  params->dsi.PLL_CLOCK = 323;//258 ;//260;//212;//208;	
...
#if defined(BUILD_LK)
  printf("ili9881p hf adc_vol is %d\n",adc_vol);
#else
  printk("ili9881p hf adc_vol is %d\n",adc_vol);
#endif
...
#if defined(BUILD_LK)
  printf("ili9881p_panda55_hf_lhd  %s,line=%d, id = 0x%x\n",__func__,__LINE__, id);
#else
  printk("ili9881p_panda55_hf_lhd  %s,line=%d, id = 0x%x\n",__func__,__LINE__, id);
#endif
