...
{0xBA ,27, {0x32, 0x83, 0x05, 0xF9, 0x0e, 0x0e, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,0x44, 0x25, 0x00, 0x91, 0x0a, 0x00, 0x00, 0x02, 0x4F, 0x11, 0x00, 0x00, 0x37}},  //0x33¨¨????????lane ?|????¨¨|??¡±¡§3lane?¡±1??o0x32
...
{0xC1 ,12, {0x54, 0x00, 0x1E, 0x1E, 0x77, 0xF3, 0xFF, 0xFF, 0xCC, 0xCC, 0x77, 0x77}},   
{0xB5 ,2, {0x0f, 0x0f}}, //0B
{0xB6 ,2, {0x32, 0x32}},  
...
{0xEA ,61, {0x02, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  
        ...
        0x88, 0x88, 0x75, 0x88, 0x23, 0x00, 0x00, 0x00, 0x54, 0x00,    
...
#if defined(BUILD_LK)
  printf("st7703_ivo55_dzx_qhd1132 %s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#else
  printk("st7703_ivo55_dzx_qhd1132 %s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER st7703_ivo55_dzx_qhd1132_lcm_drv= {
  .name           = "st7703_ivo55_dzx_qhd1132",
