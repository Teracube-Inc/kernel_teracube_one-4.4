...
#endif
//#define GPIO_GC030A_PDN2           (107+343)
...
*/
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B, //R Gr
	.mclk = 24,//24
	...
	switch(image_mirror)
		{
		   ...
		   case IMAGE_NORMAL:
		   	     write_cmos_sensor(0x0101, 0x00);//R
			      break;
		   ...
		   case IMAGE_HV_MIRROR:
			     write_cmos_sensor(0x0101, 0x03);//B
			     break;
		}
}
#endif
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0x0101,0x03);//00
...
static kal_uint32 open(void)
{
	...
	sensor_init();
	//gpio_set_value_cansleep(GPIO_GC030A_PDN2, 0);
#ifdef CONFIG_FAKE_DUAL_CAMERA
    if(openYuvSensor() < 0)
...
static kal_uint32 close(void)
{
	...
	/*No Need to implement this function*/
	//gpio_set_value_cansleep(GPIO_GC030A_PDN2, 1);
	return ERROR_NONE;
}	/*	close  */
