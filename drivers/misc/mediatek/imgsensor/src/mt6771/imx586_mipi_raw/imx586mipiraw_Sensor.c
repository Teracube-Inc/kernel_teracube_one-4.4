...
//extern void IMX586_MIPI_update_awb(kal_uint8 i2c_write_id);
//extern bool Imx586CheckVersion(kal_uint32 imgsensor_writeid);

#define DATA_SIZE 2304
#define BYTE      unsigned char
static BYTE imx586_qsc_data[DATA_SIZE] = { 0 };
//extern bool imx586_read_otp_qsc(BYTE* data);

#define LRC_SIZE 384
static BYTE imx586_lrc_data[LRC_SIZE] = { 0 };
//extern bool imx586_read_otp_lrc(BYTE* data);
...
static void write_imx586_LRC_Data(void)
{
	kal_uint16 i;	

	for (i = 0; i < 192; i++) {
		write_cmos_sensor(0x7510 + i, imx586_lrc_data[i]);
		/* LOG_INF("imx586_lrc_data[%d] = 0x%x\n", i, imx586_lrc_data[i]); */
	}
	
	for (i = 192; i < LRC_SIZE; i++) {
		write_cmos_sensor(0x7600 + i, imx586_lrc_data[i]);
		/* LOG_INF("imx586_lrc_data[%d] = 0x%x\n", i, imx586_lrc_data[i]); */
	}
}

static void write_imx586_QSC_Data(void)
{
	kal_uint16 i;	

	for (i = 0; i < DATA_SIZE; i++) {
		write_cmos_sensor(0x7F00 + i, imx586_qsc_data[i]);
		/* LOG_INF("imx586_qsc_data[%d] = 0x%x\n", i, imx586_qsc_data[i]); */
	}
}

kal_uint16 addr_data_pair_init_imx586[] = {
	0x0136,	0x18,
	0x0137,	0x00,
	0x3C7E,	0x06,
	0x3C7F,	0x0a,
...
kal_uint16 addr_data_pair_preview_imx586[] = {
...
#if 0
kal_uint16 addr_data_pair_custom1_imx586[] = {
	0x0112,	0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x39,
...
kal_uint16 addr_data_pair_custom2_imx586[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x39,
...
kal_uint16 addr_data_pair_custom3_imx586[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x1E,
...
kal_uint16 addr_data_pair_hs_video_imx586[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x15,
...
{
	LOG_INF("E init\n");
	imx586_table_write_cmos_sensor(addr_data_pair_init_imx586,
		sizeof(addr_data_pair_init_imx586) / sizeof(kal_uint16));
	LOG_INF("L\n");
} /*	sensor_init  */
...
static void preview_setting(void)
{
	...
	imx586_table_write_cmos_sensor(addr_data_pair_preview_imx586,
         sizeof(addr_data_pair_preview_imx586) / sizeof(kal_uint16));  
...
{
	LOG_INF("E\n");
	imx586_table_write_cmos_sensor(addr_data_pair_hs_video_imx586,
		sizeof(addr_data_pair_hs_video_imx586) / sizeof(kal_uint16));
}
...
static void custom1_setting(void)
{
	...
	LOG_INF("E\n");
#if 0
	imx586_table_write_cmos_sensor(addr_data_pair_custom1_imx586,
		sizeof(addr_data_pair_custom1_imx586) / sizeof(kal_uint16));
#else
	preview_setting();
#endif
}
...
static void custom2_setting(void)
{
	...
	LOG_INF("E\n");
	imx586_table_write_cmos_sensor(addr_data_pair_custom2_imx586,
		sizeof(addr_data_pair_custom2_imx586) / sizeof(kal_uint16));
}
...
static void custom3_setting(void)
{
	...
	LOG_INF("E\n");
	imx586_table_write_cmos_sensor(addr_data_pair_custom3_imx586,
		sizeof(addr_data_pair_custom3_imx586) / sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	write_imx586_LRC_Data();
	
	//IMX586_MIPI_update_awb(imgsensor.i2c_write_id);
...
static void imx586_set_lsc_reg_setting(kal_uint8 index, kal_uint16 *regDa, MUINT32 regNum)
{
...
static void set_imx586_ATR(kal_uint16 LimitGain, kal_uint16 LtcRate, kal_uint16 PostGain)
{


}

static kal_uint32 imx586_awb_gain(SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
							 ...
							 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_SET_HDR_ATR:
			...
			set_imx586_ATR((UINT16)*feature_data,
						(UINT16)*(feature_data + 1),
						(UINT16)*(feature_data + 2));
			break;
		...
		case SENSOR_FEATURE_SET_AWB_GAIN:
			imx586_awb_gain(pSetSensorAWB);
			break;
		case SENSOR_FEATURE_SET_LSC_TBL:
			{
				kal_uint8 index = *(((kal_uint8 *)feature_para) + (*feature_para_len));

				imx586_set_lsc_reg_setting(index, feature_data_16, (*feature_para_len)/sizeof(UINT16));
			}
			break;
