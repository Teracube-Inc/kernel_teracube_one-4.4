 ...
 *
 ****************************************************************************/
#ifndef _S5K2L8MIPI_SENSOR_H
#define _S5K2L8MIPI_SENSOR_H
...
/* for s5k2l8 pdaf */
extern bool s5k2l8_read_otp_pdaf_data(kal_uint16 addr, BYTE *data, kal_uint32 size, kal_uint32 sensor_id);
